...
void LEM::SetSwitches(int panel) {
	...
	LMP_EVT_TMR_FDAI_DC_CB.Init(0, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel16CB1SwitchRow, &LMPs28VBus, 2.0);
	SE_XPTR_DC_CB.Init(64, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel16CB1SwitchRow, &LMPs28VBus, 2.0);
	RCS_B_ASC_FEED_1_CB.Init(128, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel16CB1SwitchRow, &LMPs28VBus, 5.0);
	RCS_B_ASC_FEED_2_CB.Init(192, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel16CB1SwitchRow, &LMPs28VBus, 5.0);
	RCS_B_ISOL_VLV_CB.Init(256, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel16CB1SwitchRow, &LMPs28VBus, 5.0);
	RCS_B_QUAD1_TCA_CB.Init(320, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel16CB1SwitchRow, &LMPs28VBus, 10.0);
	RCS_B_QUAD2_TCA_CB.Init(384, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel16CB1SwitchRow, &LMPs28VBus, 10.0);
	RCS_B_QUAD3_TCA_CB.Init(448, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel16CB1SwitchRow, &LMPs28VBus, 10.0);
	RCS_B_QUAD4_TCA_CB.Init(512, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel16CB1SwitchRow, &LMPs28VBus, 10.0);
	RCS_B_CRSFD_CB.Init(576, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel16CB1SwitchRow, &LMPs28VBus, 5.0);
	RCS_B_TEMP_PRESS_DISP_FLAGS_CB.Init(640, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel16CB1SwitchRow, &LMPs28VBus, 2.0);
	RCS_B_PQGS_DISP_CB.Init(704, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel16CB1SwitchRow, &LMPs28VBus, 2.0);
	RCS_B_MAIN_SOV_CB.Init(768, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel16CB1SwitchRow, &LMPs28VBus, 5.0);
	PROP_DISP_ENG_OVRD_LOGIC_CB.Init(832, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel16CB1SwitchRow, &LMPs28VBus, 2.0);
	PROP_PQGS_CB.Init(896, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel16CB1SwitchRow, &LMPs28VBus, 2.0);
	PROP_ASC_HE_REG_CB.Init(1019, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel16CB1SwitchRow, &LMPs28VBus, 5.0);

	Panel16CB2SwitchRow.Init(AID_LEM_P16_CB_ROW2, MainPanel);
	LTG_FLOOD_CB.Init(0, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel16CB2SwitchRow, &LMPs28VBus, 5.0);
	LTG_TRACK_CB.Init(64, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel16CB2SwitchRow, &LMPs28VBus, 20.0);
	LTG_ANUN_DOCK_COMPNT_CB.Init(128, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel16CB2SwitchRow, &LMPs28VBus, 2.0);
	LTG_MASTER_ALARM_CB.Init(192, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel16CB2SwitchRow, &LMPs28VBus, 2.0);
	EDS_CB_LOGIC_B.Init(256, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel16CB2SwitchRow, &LMPs28VBus, 2.0);
	SCS_AEA_CB.Init(320, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel16CB2SwitchRow, &LMPs28VBus, 10.0);
	SCS_ENG_ARM_CB.Init(384, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel16CB2SwitchRow, &LMPs28VBus, 2.0);
	SCS_ASA_CB.Init(448, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel16CB2SwitchRow, &LMPs28VBus, 20.0);
	SCS_AELD_CB.Init(512, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel16CB2SwitchRow, &LMPs28VBus, 7.5);
	SCS_ATCA_CB.Init(576, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel16CB2SwitchRow, &LMPs28VBus, 7.5);
	SCS_ABORT_STAGE_CB.Init(640, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel16CB2SwitchRow, &LMPs28VBus, 2.0);
	SCS_ATCA_AGS_CB.Init(704, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel16CB2SwitchRow, &LMPs28VBus, 3.0);
	SCS_DES_ENG_OVRD_CB.Init(768, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel16CB2SwitchRow, &LMPs28VBus, 10.0);
	INST_CWEA_CB.Init(832, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel16CB2SwitchRow, &LMPs28VBus, 2.0);
	INST_SIG_SENSOR_CB.Init(896, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel16CB2SwitchRow, &LMPs28VBus, 2.0);
	INST_PCMTEA_CB.Init(1019, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel16CB2SwitchRow, &LMPs28VBus, 2.0);
	INST_SIG_CONDR_2_CB.Init(1083, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel16CB2SwitchRow, &LMPs28VBus, 2.0);
	ECS_SUIT_FLOW_CONT_CB.Init(1147, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel16CB2SwitchRow, &LMPs28VBus, 5.0);

	Panel16CB3SwitchRow.Init(AID_LEM_P16_CB_ROW3, MainPanel);
	COMM_DISP_CB.Init(0, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel16CB3SwitchRow, &LMPs28VBus, 2.0);
	COMM_SE_AUDIO_CB.Init(64, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel16CB3SwitchRow, &LMPs28VBus, 2.0);
	COMM_VHF_XMTR_A_CB.Init(128, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel16CB3SwitchRow, &LMPs28VBus, 5.0);
	COMM_VHF_RCVR_B_CB.Init(192, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel16CB3SwitchRow, &LMPs28VBus, 2.0);
	COMM_PRIM_SBAND_PA_CB.Init(256, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel16CB3SwitchRow, &LMPs28VBus, 7.5);
	COMM_PRIM_SBAND_XCVR_CB.Init(320, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel16CB3SwitchRow, &LMPs28VBus, 5.0);
	COMM_SBAND_ANT_CB.Init(384, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel16CB3SwitchRow, &LMPs28VBus, 2.0);
	COMM_PMP_CB.Init(448, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel16CB3SwitchRow, &LMPs28VBus, 2.0);
	COMM_TV_CB.Init(512, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel16CB3SwitchRow, &LMPs28VBus, 2.0);
	ECS_DISP_CB.Init(576, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel16CB3SwitchRow, &LMPs28VBus, 2.0);
	ECS_GLYCOL_PUMP_SEC_CB.Init(640, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel16CB3SwitchRow, &LMPs28VBus, 5.0);
	ECS_LGC_PUMP_CB.Init(768, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel16CB3SwitchRow, &LMPs28VBus, 5.0);
	ECS_CABIN_FAN_CONT_CB.Init(832, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel16CB3SwitchRow, &LMPs28VBus, 2.0);
	ECS_CABIN_REPRESS_CB.Init(896, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel16CB3SwitchRow, &LMPs28VBus, 2.0);
	ECS_SUIT_FAN_2_CB.Init(1019, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel16CB3SwitchRow, &LMPs28VBus, 20.0);
	ECS_SUIT_FAN_DP_CB.Init(1083, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel16CB3SwitchRow, &LMPs28VBus, 2.0);
	ECS_DIVERT_VLV_CB.Init(1147, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel16CB3SwitchRow, &LMPs28VBus, 2.0);
	ECS_CO2_SENSOR_CB.Init(1211, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel16CB3SwitchRow, &LMPs28VBus, 2.0);

	Panel16CB4SwitchRow.Init(AID_LEM_P16_CB_ROW4, MainPanel);
	RCS_QUAD_1_LMP_HTR_CB.Init(0, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel16CB4SwitchRow, &LMPs28VBus, 7.5);
	RCS_QUAD_2_LMP_HTR_CB.Init(64, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel16CB4SwitchRow, &LMPs28VBus, 7.5);
	RCS_QUAD_3_LMP_HTR_CB.Init(128, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel16CB4SwitchRow, &LMPs28VBus, 7.5);
	RCS_QUAD_4_LMP_HTR_CB.Init(192, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel16CB4SwitchRow, &LMPs28VBus, 7.5);
	HTR_DISP_CB.Init(256, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel16CB4SwitchRow, &LMPs28VBus, 2.0);
	HTR_SBD_ANT_CB.Init(320, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel16CB4SwitchRow, &LMPs28VBus, 5.0);
	CAMR_SEQ_CB.Init(384, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel16CB4SwitchRow, &LMPs28VBus, 2.0);
	EPS_DISP_CB.Init(448, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel16CB4SwitchRow, &LMPs28VBus, 2.0);
	LMPDCBusVoltCB.Init(512, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel16CB4SwitchRow, &LMPs28VBus, 2.0);
	LMPInverter2CB.Init(576, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel16CB4SwitchRow, &LMPs28VBus, 30.0);
	LMPAscECAMainCB.Init(640, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel16CB4SwitchRow, &LMPs28VBus, 2.0);
	LMPAscECAContCB.Init(704, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel16CB4SwitchRow, &LMPs28VBus, 3.0);
	LMPDesECAMainCB.Init(768, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel16CB4SwitchRow, &LMPs28VBus, 3.0);
	LMPDesECAContCB.Init(832, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel16CB4SwitchRow, &LMPs28VBus, 5.0);
	LMPXLunarBusTieCB.Init(896, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel16CB4SwitchRow, &LMPs28VBus, 50.0);
	LMPCrossTieBusCB.Init(1019, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel16CB4SwitchRow, &LMPs28VBus, 100.0);
	LMPCrossTieBalCB.Init(1083, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel16CB4SwitchRow, &LMPs28VBus, 30.0);
	LMPBatteryFeedTieCB1.Init(1147, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel16CB4SwitchRow, &BTB_LMP_B, 100.0);
	LMPBatteryFeedTieCB2.Init(1211, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel16CB4SwitchRow, &BTB_LMP_C, 100.0);
	...
	SE_WND_HTR_AC_CB.Init(3, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel11CB1SwitchRow, &ACBusB, 2.0);
	HE_PQGS_PROP_DISP_AC_CB.Init(67, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel11CB1SwitchRow, &ACBusB, 2.0);
	SBD_ANT_AC_CB.Init(131, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel11CB1SwitchRow, &ACBusB, 2.0);
	ORDEAL_AC_CB.Init(195, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel11CB1SwitchRow, &ACBusB, 2.0);
	AGS_AC_CB.Init(318, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel11CB1SwitchRow, &ACBusB, 2.0);
	AOT_LAMP_ACB_CB.Init(382, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel11CB1SwitchRow, &ACBusB, 2.0);
	LMP_FDAI_AC_CB.Init(446, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel11CB1SwitchRow, &ACBusB, 2.0);
	NUM_LTG_AC_CB.Init(510, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel11CB1SwitchRow, &ACBusB, 2.0);
	AC_B_INV_2_FEED_CB.Init(574, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel11CB1SwitchRow, &INV_2, 5.0);
	AC_B_INV_1_FEED_CB.Init(638, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel11CB1SwitchRow, &INV_1, 5.0);
	AC_A_INV_2_FEED_CB.Init(702, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel11CB1SwitchRow, &INV_2, 5.0);
	AC_A_INV_1_FEED_CB.Init(766, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel11CB1SwitchRow, &INV_1, 5.0);
	AC_A_BUS_VOLT_CB.Init(830, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel11CB1SwitchRow, &ACBusA, 2.0);
	CDR_WND_HTR_AC_CB.Init(894, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel11CB1SwitchRow, &ACBusA, 2.0);
	TAPE_RCDR_AC_CB.Init(958, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel11CB1SwitchRow, &ACBusA, 2.0);
	AOT_LAMP_ACA_CB.Init(1022, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel11CB1SwitchRow, &ACBusA, 2.0);
	RDZ_RDR_AC_CB.Init(1086, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel11CB1SwitchRow, &ACBusA, 2.0);
	DECA_GMBL_AC_CB.Init(1150, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel11CB1SwitchRow, &ACBusA, 2.0);
	INTGL_LTG_AC_CB.Init(1214, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel11CB1SwitchRow, &ACBusA, 2.0);

	Panel11CB2SwitchRow.Init(AID_LEM_P11_CB_ROW2, MainPanel);
	RCS_A_MAIN_SOV_CB.Init(3, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel11CB2SwitchRow, &CDRs28VBus, 5.0);
	RCS_A_QUAD4_TCA_CB.Init(67, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel11CB2SwitchRow, &CDRs28VBus, 10.0);
	RCS_A_QUAD3_TCA_CB.Init(131, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel11CB2SwitchRow, &CDRs28VBus, 10.0);
	RCS_A_QUAD2_TCA_CB.Init(195, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel11CB2SwitchRow, &CDRs28VBus, 10.0);
	RCS_A_QUAD1_TCA_CB.Init(318, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel11CB2SwitchRow, &CDRs28VBus, 10.0);
	RCS_A_ISOL_VLV_CB.Init(382, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel11CB2SwitchRow, &CDRs28VBus, 5.0);
	RCS_A_ASC_FEED_2_CB.Init(446, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel11CB2SwitchRow, &CDRs28VBus, 5.0);
	RCS_A_ASC_FEED_1_CB.Init(510, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel11CB2SwitchRow, &CDRs28VBus, 5.0);
	THRUST_DISP_CB.Init(574, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel11CB2SwitchRow, &CDRs28VBus, 2.0);
	MISSION_TIMER_CB.Init(638, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel11CB2SwitchRow, &CDRs28VBus, 2.0);
	CDR_XPTR_CB.Init(702, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel11CB2SwitchRow, &CDRs28VBus, 2.0);
	RNG_RT_ALT_RT_DC_CB.Init(766, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel11CB2SwitchRow, &CDRs28VBus, 2.0);
	GASTA_DC_CB.Init(830, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel11CB2SwitchRow, &CDRs28VBus, 2.0);
	CDR_FDAI_DC_CB.Init(894, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel11CB2SwitchRow, &CDRs28VBus, 2.0);
	COAS_DC_CB.Init(958, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel11CB2SwitchRow, &CDRs28VBus, 2.0);
	ORDEAL_DC_CB.Init(1022, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel11CB2SwitchRow, &CDRs28VBus, 2.0);
	RNG_RT_ALT_RT_AC_CB.Init(1086, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel11CB2SwitchRow, &ACBusA, 2.0);
	GASTA_AC_CB.Init(1150, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel11CB2SwitchRow, &ACBusA, 2.0);
	CDR_FDAI_AC_CB.Init(1214, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel11CB2SwitchRow, &ACBusA, 2.0);

	Panel11CB3SwitchRow.Init(AID_LEM_P11_CB_ROW3, MainPanel); // 184,431 to 1433,459
	PROP_DES_HE_REG_VENT_CB.Init(3, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel11CB3SwitchRow, &CDRs28VBus, 5.0);
	HTR_RR_STBY_CB.Init(67, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel11CB3SwitchRow, &CDRs28VBus, 7.5);
	HTR_RR_OPR_CB.Init(131, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel11CB3SwitchRow, &CDRs28VBus, 7.5);
	HTR_LR_CB.Init(195, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel11CB3SwitchRow, &CDRs28VBus, 5.0);
	HTR_DOCK_WINDOW_CB.Init(318, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel11CB3SwitchRow, &CDRs28VBus, 2.0);
	HTR_AOT_CB.Init(382, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel11CB3SwitchRow, &CDRs28VBus, 2.0);
	INST_SIG_CONDR_1_CB.Init(446, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel11CB3SwitchRow, &CDRs28VBus, 2.0);
	CDR_SCS_AEA_CB.Init(510, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel11CB3SwitchRow, &CDRs28VBus, 10.0);
	CDR_SCS_ABORT_STAGE_CB.Init(574, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel11CB3SwitchRow, &CDRs28VBus, 2.0);
	CDR_SCS_ATCA_CB.Init(638, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel11CB3SwitchRow, &CDRs28VBus, 2.0);
	CDR_SCS_AELD_CB.Init(702, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel11CB3SwitchRow, &CDRs28VBus, 7.5);
	SCS_ENG_CONT_CB.Init(766, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel11CB3SwitchRow, &CDRs28VBus, 2.0);
	SCS_ATT_DIR_CONT_CB.Init(830, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel11CB3SwitchRow, &CDRs28VBus, 10.0);
	SCS_ENG_START_OVRD_CB.Init(894, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel11CB3SwitchRow, &CDRs28VBus, 2.0);
	SCS_DECA_PWR_CB.Init(958, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel11CB3SwitchRow, &CDRs28VBus, 20.0);
	EDS_CB_LG_FLAG.Init(1022, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel11CB3SwitchRow, &CDRs28VBus, 2.0);
	EDS_CB_LOGIC_A.Init(1086, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel11CB3SwitchRow, &CDRs28VBus, 2.0);
	CDR_LTG_UTIL_CB.Init(1150, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel11CB3SwitchRow, &CDRs28VBus, 2.0);
	CDR_LTG_ANUN_DOCK_COMPNT_CB.Init(1214, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel11CB3SwitchRow, &CDRs28VBus, 2.0);

	Panel11CB4SwitchRow.Init(AID_LEM_P11_CB_ROW4, MainPanel);
	RCS_QUAD_4_CDR_HTR_CB.Init(3, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel11CB4SwitchRow, &CDRs28VBus, 7.5);
	RCS_QUAD_3_CDR_HTR_CB.Init(67, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel11CB4SwitchRow, &CDRs28VBus, 7.5);
	RCS_QUAD_2_CDR_HTR_CB.Init(131, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel11CB4SwitchRow, &CDRs28VBus, 7.5);
	RCS_QUAD_1_CDR_HTR_CB.Init(195, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel11CB4SwitchRow, &CDRs28VBus, 7.5);
	ECS_SUIT_FAN_1_CB.Init(318, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel11CB4SwitchRow, &CDRs28VBus, 20.0);
	ECS_CABIN_FAN_1_CB.Init(382, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel11CB4SwitchRow, &CDRs28VBus, 5.0);
	ECS_GLYCOL_PUMP_2_CB.Init(446, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel11CB4SwitchRow, &CDRs28VBus, 5.0);
	ECS_GLYCOL_PUMP_1_CB.Init(510, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel11CB4SwitchRow, &CDRs28VBus, 5.0);
	ECS_GLYCOL_PUMP_AUTO_XFER_CB.Init(574, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel11CB4SwitchRow, &CDRs28VBus, 2.0);
	COMM_UP_DATA_LINK_CB.Init(638, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel11CB4SwitchRow, &CDRs28VBus, 2.0);
	COMM_SEC_SBAND_XCVR_CB.Init(702, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel11CB4SwitchRow, &CDRs28VBus, 5.0);
	COMM_SEC_SBAND_PA_CB.Init(766, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel11CB4SwitchRow, &CDRs28VBus, 7.5);
	COMM_VHF_XMTR_B_CB.Init(830, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel11CB4SwitchRow, &CDRs28VBus, 5.0);
	COMM_VHF_RCVR_A_CB.Init(894, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel11CB4SwitchRow, &CDRs28VBus, 2.0);
	COMM_CDR_AUDIO_CB.Init(958, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel11CB4SwitchRow, &CDRs28VBus, 2.0);
	PGNS_SIG_STR_DISP_CB.Init(1022, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel11CB4SwitchRow, &CDRs28VBus, 2.0);
	PGNS_LDG_RDR_CB.Init(1086, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel11CB4SwitchRow, &CDRs28VBus, 10.0);
	PGNS_RNDZ_RDR_CB.Init(1150, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel11CB4SwitchRow, &CDRs28VBus, 15.0);
	LGC_DSKY_CB.Init(1214, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel11CB4SwitchRow, &CDRs28VBus, 7.5);
	IMU_SBY_CB.Init(1278, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel11CB4SwitchRow, &CDRs28VBus, 5.0);
	IMU_OPR_CB.Init(1342, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel11CB4SwitchRow, &CDRs28VBus, 20.0);

	Panel11CB5SwitchRow.Init(AID_LEM_P11_CB_ROW5, MainPanel);
	CDRBatteryFeedTieCB1.Init(3, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel11CB5SwitchRow, &BTB_CDR_B, 100.0);
	CDRBatteryFeedTieCB2.Init(67, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel11CB5SwitchRow, &BTB_CDR_C, 100.0);
	CDRCrossTieBalCB.Init(131, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel11CB5SwitchRow, &CDRs28VBus, 30.0);
	CDRCrossTieBusCB.Init(195, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel11CB5SwitchRow, &CDRs28VBus, 100.0);
	CDRXLunarBusTieCB.Init(318, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel11CB5SwitchRow, &CDRs28VBus, 50.0);
	CDRDesECAContCB.Init(382, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel11CB5SwitchRow, &CDRs28VBus, 5.0);
	CDRDesECAMainCB.Init(446, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel11CB5SwitchRow, &CDRs28VBus, 3.0);
	CDRAscECAContCB.Init(510, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel11CB5SwitchRow, &CDRs28VBus, 3.0);
	CDRAscECAMainCB.Init(574, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel11CB5SwitchRow, &CDRs28VBus, 2.0);
	CDRInverter1CB.Init(638, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel11CB5SwitchRow, &CDRs28VBus, 30.0);
	CDRDCBusVoltCB.Init(702, 0, 29, 29, srf[SRF_CIRCUITBREAKER], srf[SRF_BORDER_29x29], Panel11CB5SwitchRow, &CDRs28VBus, 2.0);
